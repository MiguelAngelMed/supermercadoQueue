...
Descripcion: Recibe una cola y un numero de elemento de 1 al tamaño de la cola y retorna el elemento de esa posicion.
Devuelve: elemento en la posicion i de la cola
Observaciones: El numero i debera estar entre 1 y el tamaño de la cola, si esta es vacia o mas pequeña se provoca un error.
*/
