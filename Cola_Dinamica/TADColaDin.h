...
//Definir un nodo que será utilizado para almacenar una posición de la cola (Nodo),
//lo que incluirá a un elemento y a un apuntador al siguiente nodo
typedef struct nodo
{
...
//Definir una cola (Se modela con una estructura que incluye únicamente
//dos apuntadores a elementos, para controlar el frente y final de la cola)
typedef struct cola
{
	nodo *frente;
	nodo *final;
